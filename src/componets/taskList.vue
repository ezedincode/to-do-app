...
<template>
    ...
    <div class=" h-16 w-11/12 bg-white rounded-[10px] flex justify-between">
            ...
            <div class="flex gap-6 items-center ">
                <img @click="edit(value.id)" class="w-5 cursor-pointer h-5" src="data:image/png;base64," alt="pencil--v1">
                <img class="w-5 cursor-pointer h-5" src="https://img.icons8.com/?size=100&id=102315&format=png&color=000000" @click="deleteTodo(value.id)" alt="">
                <img  @click="completed(value.id)" class="w-5 cursor-pointer h-5" src="\src\resource\check-mark.png" alt="">

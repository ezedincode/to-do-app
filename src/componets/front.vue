...
<template>
  ...
  <div v-for="(value,index) in store.todos" :key="index" class="flex flex-col items-center">
        <div class="h-16 w-11/12 bg-white rounded-[10px] flex justify-between">
            ...
            <div class="flex gap-4">
                ...
                <img class="w-5 h-5" src="https://img.icons8.com/?size=100&id=102315&format=png&color=000000" alt="">
                <img src="" alt="">
            </div>
